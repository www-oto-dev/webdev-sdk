...
class PropertiesService(BaseService):
    ...
    def new(
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url or Environment.DEFAULT.url}/properties/revision/new",
                [self.get_api_key()],
            )
    ...
    def get(self, name: str, build: Union[str, None] = SENTINEL) -> str:
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url or Environment.DEFAULT.url}/properties/actual/get",
                [self.get_api_key()],
            )
            .add_query("name", name)
            .add_query("build", build, nullable=True)
    ...
    def set(
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url or Environment.DEFAULT.url}/properties/actual/set",
                [self.get_api_key()],
            )
            .add_query("name", name)
    ...
    def add(
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url or Environment.DEFAULT.url}/properties/actual/add",
                [self.get_api_key()],
            )
            .add_query("name", name)
            .add_query("value", value, nullable=True)
    ...
    def all(
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url or Environment.DEFAULT.url}/properties/all/get",
                [self.get_api_key()],
            )
    ...
    def update(
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url or Environment.DEFAULT.url}/properties/all/update",
                [self.get_api_key()],
            )
            .add_query("build", build, nullable=True)
            .serialize()
    ...
    def remove(
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url or Environment.DEFAULT.url}/properties/all/remove",
                [self.get_api_key()],
            )
            .add_query("name", name, nullable=True)
            .add_query("value", value, nullable=True)
    ...
    def display(
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url or Environment.DEFAULT.url}/properties/all/display",
                [self.get_api_key()],
            )
            .add_query("name", name, nullable=True)
            .add_query("build", build, nullable=True)
