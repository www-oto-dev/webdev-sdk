...
|---------------------|-------------------------------------------|-------------------------------------------------------------------------------------|--------------------------|
| [Properties](framework/documentation/servies/PropertiesService.md) | [Property](framework/documentation/models/Property.md) | Controls project properties. [more info](#project-properties) | ☑️ Supports revisions by refering to specific Build (version generated by `oto.project.build()` command | 
