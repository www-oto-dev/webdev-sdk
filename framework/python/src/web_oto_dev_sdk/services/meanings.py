...
class MeaningsService(BaseService):
    ...
    def new(
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url or Environment.DEFAULT.url}/meanings/revision/new",
                [self.get_api_key()],
            )
    ...
    def get(self, name: str, collection: Union[str, None] = SENTINEL) -> str:
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url or Environment.DEFAULT.url}/meanings/actual/get",
                [self.get_api_key()],
            )
            .add_query("name", name)
            .add_query("collection", collection, nullable=True)
    ...
    def set(
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url or Environment.DEFAULT.url}/meanings/actual/set",
                [self.get_api_key()],
            )
            .add_query("name", name)
    ...
    def add(
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url or Environment.DEFAULT.url}/meanings/actual/add",
                [self.get_api_key()],
            )
            .add_query("name", name)
            .add_query("value", value, nullable=True)
    ...
    def all(
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url or Environment.DEFAULT.url}/meanings/all/get",
                [self.get_api_key()],
            )
    ...
    def update(
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url or Environment.DEFAULT.url}/meanings/all/update",
                [self.get_api_key()],
            )
            .add_query("collection", collection, nullable=True)
            .serialize()
    ...
    def remove(
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url or Environment.DEFAULT.url}/meanings/all/remove",
                [self.get_api_key()],
            )
            .add_query("name", name, nullable=True)
            .add_query("value", value, nullable=True)
    ...
    def display(
        ...
        serialized_request = (
            Serializer(
                f"{self.base_url or Environment.DEFAULT.url}/meanings/all/display",
                [self.get_api_key()],
            )
            .add_query("name", name, nullable=True)
            .add_query("collection", collection, nullable=True)
